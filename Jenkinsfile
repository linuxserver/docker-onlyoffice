pipeline {
  ...
  environment {
    ...
    EXT_USER = 'ONLYOFFICE'
    EXT_REPO = 'DesktopEditors'
    BUILD_VERSION_ARG = 'ONLYOFFICE_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-onlyoffice'
    CONTAINER_NAME = 'onlyoffice'
    DOCKERHUB_IMAGE = 'linuxserver/onlyoffice'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/onlyoffice'
    PR_DOCKERHUB_IMAGE = 'lspipepr/onlyoffice'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-onlyoffice/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-onlyoffice\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-onlyoffice\" \
          ...
          --label \"org.opencontainers.image.description=[ONLYOFFICE](https://www.onlyoffice.com/) provides a full range of tools to create, edit and collaborate on text documents, spreadsheets, presentations, PDF forms and regular PDF files on web, desktop and mobile platforms.\" \
